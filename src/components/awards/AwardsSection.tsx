...
import type { AwardsMode, AwardsSectionProps } from '@/src/types/components/awards'
import AwardsModeToggle from '@/src/components/awards/AwardsModeToggle'
import AwardsShelf from './AwardsShelf'
import AwardDetails from '@/src/components/awards/AwardDetails'
