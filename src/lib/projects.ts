...
export const projects: Project[] = [
  ...
  },
  {
    slug: "eigenhand",
    name: "EigenHand",
    tagline: "Extração de Landmarks de Mão em NumPy Puro",
    category: "IA & Dados",
    cover: "/images/projetos/eigenhand.png",
    coverFit: "cover",
    summaryShort:
      "Pipeline de extração de landmarks de mãos construído do zero com Álgebra Linear pura e NumPy, sem uso de frameworks de deep learning. Projeto de mestrado em Ciência da Computação.",
    summaryLong:
      "EigenHand é um projeto de mestrado em Ciência da Computação focado em processamento de imagens e visão computacional usando fundamentação matemática rigorosa. O pipeline realiza a extração de landmarks de mãos aplicando segmentação por cosseno em R³, Principal Component Analysis (PCA), Graham Scan (Convex Hull), mudança de base ortogonal e cálculos de imagem integral, tudo desenvolvido do zero utilizando apenas Álgebra Linear e a biblioteca NumPy.",
    highlights: [
      "Desenvolvido 100% com NumPy e Álgebra Linear",
      "Segmentação por cosseno no espaço R³",
      "Redução de dimensionalidade via PCA",
      "Implementação do algoritmo Graham Scan",
      "Performance otimizada via Imagem Integral",
    ],
    stack: [
      "Python",
      "NumPy",
    ...
    status: "Concluído",
    links: [{ label: "github.com/Jovinull/EigenHand", href: "https://github.com/Jovinull/EigenHand" }],
    featured: true,
  },
  {
    slug: "bixim",
    name: "Bixim",
    tagline: "Cross-platform Virtual Pet Engine (ESP32/PC)",
    category: "IoT & Embarcados",
    cover: "/images/projetos/bixim.png",
    coverFit: "cover",
    summaryShort:
      "Engine multiplataforma para um bichinho virtual, rodando tanto em ESP32 com display OLED quanto nativamente no PC, escrita em C/C++ puro com arquitetura HAL.",
    summaryLong:
      "O Bixim não é apenas um jogo, mas uma engine focada em arquitetura de hardware e software. Utiliza uma camada de abstração de hardware (HAL) para permitir que o mesmo código C/C++ rode em um microcontrolador ESP32 com display OLED SSD1306 e no PC de forma idêntica. Possui um game loop com timestep fixo e máquina de estados finitos (FSM) que controla toda a lógica e humor do bichinho virtual.",
    highlights: [
      "Arquitetura HAL (Hardware Abstraction Layer) cross-platform",
      "Game loop determinístico com timestep fixo",
      "Lógica FSM (Finite State Machine) para a AI do bichinho",
      "Renderização em display OLED via SSD1306",
      "Base de código unificada para Microcontrolador e Desktop",
    ],
    stack: [
      "C++",
      "ESP32",
    ...
    status: "Concluído",
    links: [{ label: "github.com/Jovinull/Bixim", href: "https://github.com/Jovinull/Bixim" }],
    featured: true,
  },
  {
    slug: "stormcore",
    name: "StormCore & NimbusHub",
    tagline: "Estação Meteorológica IoT + Dashboard de Dados",
    category: "Full Stack",
    cover: "/images/projetos/stormcore.png",
    coverFit: "cover",
    summaryShort:
      "Ecossistema completo de IoT: uma estação meteorológica DIY com ESP32 transmitindo via MQTT para um dashboard real-time em Next.js.",
    summaryLong:
      "Um projeto IoT de ponta a ponta. O hardware (StormCore) usa um ESP32 conectado a sensores DHT22, BMP180, medidor de velocidade do vento e pluviômetro para coletar dados do mundo real. Esses dados são transmitidos em tempo real via protocolo MQTT (HiveMQ). No front-end (NimbusHub), um dashboard desenvolvido em Next.js se inscreve nesses tópicos para renderizar bússolas interativas de direção do vento, gráficos históricos e gauges de métricas com latência zero.",
    highlights: [
      "Estação meteorológica customizada (ESP32 + Sensores Ambientais)",
      "Transmissão e orquestração de dados em tempo real via MQTT",
      "Dashboard dinâmico full stack usando Next.js e TailwindCSS",
      "Componentes de UI avançados (bússola de vento, gráficos temporais)",
      "Integração nuvem-borda (Cloud-to-Edge)",
    ],
    stack: [
      "ESP32",
      "C++",
    ...
    status: "Concluído",
    links: [
      { label: "StormCore (Hardware)", href: "https://github.com/Jovinull/StormCore" },
      { label: "NimbusHub (Dashboard)", href: "https://github.com/Jovinull/NimbusHub" },
    ],
    featured: true,
  },
  {
