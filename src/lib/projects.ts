export type ProjectCategory = "Backend/API" | "Games" | "Gráficos & Sistemas" | "Full Stack" | "IA & Dados" | "IoT & Embarcados" | "Educação" | "Open Source";
...
export const projects: Project[] = [
  ...
  },
  {
    slug: "omaloon",
    name: "Omaloon",
    tagline: "Expansão maciça de conteúdo para Mindustry",
    category: "Open Source",
    cover: "https://opengraph.githubassets.com/1/stabu-dev/Omaloon",
    coverFit: "cover",
    summaryShort: "Contribuições de peso ao Omaloon, mod para o jogo Mindustry: refatoração de simulação de pressão usando interfaces, melhorias gráficas e remoção de dependências externas.",
    summaryLong: "Contribui ativamente com melhorias estruturais e correções no Omaloon. Dentre as principais PRs, removi a pesada lógica baseada em reflexão (reflection) no cálculo de pressão de líquidos, substituindo-a por interfaces orientadas a objetos, o que resultou em ganhos significativos de performance. Também implementei o desenho de polígonos (donutEllipse) de forma nativa para cortar dependências de terceiros, consertei o 'flickering' de líquidos nos canos e adicionei localizações.",
    highlights: [
      "Refatoração profunda da lógica de simulação de pressão (PressureModule)",
      "Remoção de reflexão em favor de interfaces para alta performance",
      "Implementação de lógica gráfica nativa sem bibliotecas externas",
    ],
    stack: ["Java", "Mindustry API", "Game Engine", "Refactoring"],
    status: "Concluído",
    links: [{ label: "stabu-dev/Omaloon", href: "https://github.com/stabu-dev/Omaloon" }],
    featured: false,
  },
  {
    slug: "mindustry-client",
    name: "Mindustry Anti-Grief Client",
    tagline: "Cliente modificado contra griefing",
    category: "Open Source",
    cover: "https://opengraph.githubassets.com/1/mindustry-antigrief/mindustry-client",
    coverFit: "cover",
    summaryShort: "Adição do suporte completo ao idioma Português (pt-BR) neste cliente focado em evitar destruição de servidores.",
    summaryLong: "Contribuição focada em internacionalização (i18n). Este cliente modificado de Mindustry é muito famoso na comunidade por suas ferramentas de moderação e proteção anti-griefing. Realizei o levantamento das chaves de localização e implementei toda a tradução para Português Brasileiro.",
    highlights: [
      "Tradução e revisão completa de chaves de localização",
      "Internacionalização do cliente e da interface",
    ],
    stack: ["Java", "i18n", "Properties"],
    status: "Concluído",
    links: [{ label: "mindustry-antigrief/mindustry-client", href: "https://github.com/mindustry-antigrief/mindustry-client" }],
    featured: false,
  },
  {
    slug: "new-horizon-mod",
    name: "New Horizon Mod",
    tagline: "Efeitos visuais e melhorias (Mindustry)",
    category: "Open Source",
    cover: "https://opengraph.githubassets.com/1/Yuria-Shikibe/NewHorizonMod",
    coverFit: "cover",
    summaryShort: "Fixes críticos de renderização gráfica do Framebuffer com efeitos de Pixelate e resolução de bugs de compatibilidade vanilla no mod.",
    summaryLong: "O New Horizon Mod é gigantesco na comunidade e adiciona muitas mecânicas visuais. Atuei consertando o pipeline gráfico onde a renderização do Framebuffer falhava caso o efeito 'Pixelate' estivesse habilitado nas configurações. Além disso, corrigi um bug clássico de invisibilidade que acontecia com a 'Vanilla Factory' quando a sobrescrita de unidades estava ligada.",
    highlights: [
      "Correções gráficas diretamente na manipulação de Framebuffers",
      "Resolução de Edge-Cases entre modificação de unidades e as fábricas vanilla do jogo",
      "Atuação no sistema de preferências de UI e tradução",
    ],
    stack: ["Java", "Graphics", "Framebuffer", "Game Dev"],
    status: "Concluído",
    links: [{ label: "Yuria-Shikibe/NewHorizonMod", href: "https://github.com/Yuria-Shikibe/NewHorizonMod" }],
    featured: false,
  },
  {
    slug: "mindustry-vanilla",
    name: "Mindustry (Anuken)",
    tagline: "Contribuindo com a Engine Vanilla",
    category: "Open Source",
    cover: "https://opengraph.githubassets.com/1/Anuken/Mindustry",
    coverFit: "cover",
    summaryShort: "PRs mergeados diretamente no repositório oficial do desenvolvedor do Mindustry (Anuken).",
    summaryLong: "Contribuir diretamente na engine base é o ápice. No repositório oficial do Anuken, completei a localização em português brasileiro e propus melhorias na interface gráfica (como novos settings de edge padding) para garantir que a UI se comportasse bem em diversos tipos de tela e resoluções exóticas.",
    highlights: [
      "Merge oficial no repositório core da engine (Anuken/Mindustry)",
      "Melhorias e settings configuráveis para o padding das UIs in-game",
    ],
    stack: ["Java", "LibGDX", "Arc Engine"],
    status: "Concluído",
    links: [{ label: "Anuken/Mindustry", href: "https://github.com/Anuken/Mindustry" }],
    featured: false,
  },
  {
    slug: "rinha-backend-2026",
    name: "Rinha de Backend 2026",
    tagline: "Submissão de Alta Performance em Zig",
    category: "Open Source",
    cover: "https://opengraph.githubassets.com/1/zanfranceschi/rinha-de-backend-2026",
    coverFit: "cover",
    summaryShort: "Minha submissão oficial (jovinull-zig) construída inteiramente na linguagem low-level Zig para o torneio Rinha de Backend.",
    summaryLong: "A Rinha de Backend exige performance, baixo footprint de memória e processamento assíncrono extremamente rápido para segurar picos de estresse da bateria do Gatling. Escolhi desenvolver a minha API (jovinull-zig) totalmente na linguagem Zig para extrair o máximo das syscalls de socket com uma abstração quase nula. O projeto foi aprovado via PR oficial para os testes finais de carga.",
    highlights: [
      "Implementação completa da API RESTful concorrente em Zig",
      "Otimizações agressivas de uso de memória com arena allocators",
      "Integração contínua e dockerização minimalista da submissão",
    ],
    stack: ["Zig", "Docker", "PostgreSQL", "Performance Tuning"],
    status: "Concluído",
    links: [{ label: "zanfranceschi/rinha-de-backend-2026", href: "https://github.com/zanfranceschi/rinha-de-backend-2026" }],
    featured: false,
  },
  {
    slug: "aquarion",
    name: "Aquarion",
    tagline: "Geração procedural de planetas",
    category: "Open Source",
    cover: "https://opengraph.githubassets.com/1/Twcash/Aquarion",
    coverFit: "cover",
    summaryShort: "Refatorações no código de geração procedural planetária no mod Aquarion.",
    summaryLong: "No Aquarion, mod focado em novos ecossistemas e planetas, meu papel foi focar na qualidade do código interno. Fiz a extração e abstração de lógica duplicada que validava o raio (radius check) dentro da classe FakeSerpuloPlanetGenerator. Refatorações como essa tornam a base mais limpa para futuros contribuidores.",
    highlights: [
      "Refatoração de Clean Code removendo duplicações estruturais de geometria",
      "Tradução PT-BR abrangente dos blocos interativos do ecossistema",
    ],
    stack: ["Java", "Procedural Generation", "Clean Code"],
    status: "Concluído",
    links: [{ label: "Twcash/Aquarion", href: "https://github.com/Twcash/Aquarion" }],
    featured: false,
  },
  {
    slug: "cla-candidate",
    name: "CLA Candidate API",
    tagline: "Features de autenticação e formulários",
    category: "Open Source",
    cover: "https://opengraph.githubassets.com/1/Cla-Code-Community/candidate",
    coverFit: "cover",
    summaryShort: "Contribuições de full-stack resolvendo as issues de Registro de Usuários para a comunidade CLA.",
    summaryLong: "Para o projeto da comunidade Cla-Code, implementei a feature robusta de User Registration (Registro de Usuário). O desenvolvimento englobou desde os formulários de frontend até a garantia de que o backend recebesse, validasse e armazenasse corretamente os dados ausentes. Foi uma contribuição completa de ponta-a-ponta visando resolver issues abertas no board.",
    highlights: [
      "Implementação do fluxo completo de User Registration",
      "Validações e mapeamento de campos ausentes em formulários (Frontend/Backend)",
    ],
    stack: ["TypeScript", "Full-Stack", "Auth Flow"],
    status: "Concluído",
    links: [{ label: "Cla-Code-Community/candidate", href: "https://github.com/Cla-Code-Community/candidate" }],
    featured: false,
  }
];;
