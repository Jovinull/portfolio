...
import SectionReveal from '@/src/components/motion/SectionReveal';

import { workData } from '@/assets/assets';
import ProjectsHero from '@/src/components/projects/ProjectsHero';
import FeaturedProjectsSpotlight from '@/src/components/projects/FeaturedProjectsSpotlight';
import ProjectsList from '@/src/components/projects/ProjectsList';
import PageNavbar from '@/src/components/navbar/PageNavbar';
